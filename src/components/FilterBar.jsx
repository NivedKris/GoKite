  ...
  useEffect(() => {
    api.companies()
      ...
      .catch(() => {
        ...
        const fallback = [
          { id: 1, name: 'GoKite Main Branch' },
          { id: 2, name: 'GoKite Al Barsha' },
          { id: 3, name: 'GoKite Deira' },
          { id: 4, name: 'GoKite Sharjah' },
      ...
      <div className="flex flex-wrap items-end gap-3">
        ...
        <div className="flex items-end gap-2 pb-0">
          ...
          <button
            type="button"
            onClick={handleClear}
            className="px-5 py-2 text-slate-600 text-sm font-bold hover:bg-slate-100 rounded-lg transition-colors"
          >
            Clear
          </button>
        </div>
